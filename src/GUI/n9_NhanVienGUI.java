 ...
 * @author phuoc
 */
public class n9_NhanVienGUI extends javax.swing.JPanel {

    public n9_NhanVienGUI() {
        initComponents();
        nhomNutChucNang();
    ...
    private void initComponents() {
        BtnQLNhanVien = new Util.PanelRound();
        BtnQLPhanQuyen = new Util.PanelRound();
        BtnThongTinTK = new Util.PanelRound();
        BtnThem = new Util.PanelRound();
        BtnSua = new Util.PanelRound();
        BtnXuat = new Util.PanelRound();
        BtnNhap = new Util.PanelRound();
        BtnRefresh = new Util.PanelRound();
        PanelTimKiem = new Util.PanelRound();
        BtnThemTaiKhoan = new Util.PanelRound();
        BtnKhoaTK = new Util.PanelRound();
        ...
        BtnQLNhanVien.setRoundBottomRight(40);
        BtnQLNhanVien.setRoundTopLeft(40);

        BtnQLPhanQuyen.setRoundBottomRight(40);
        BtnQLPhanQuyen.setRoundTopLeft(40);

        BtnSua.setRoundBottomRight(20);
        BtnSua.setRoundTopLeft(20);
        BtnSua.setRoundTopRight(20);
        BtnSua.setRoundBottomLeft(20);
        
        BtnThem.setRoundBottomRight(20);
        BtnThem.setRoundTopLeft(20);
        BtnThem.setRoundTopRight(20);
        BtnThem.setRoundBottomLeft(20);
        
        BtnKhoaTK.setRoundBottomRight(20);
        BtnKhoaTK.setRoundTopLeft(20);
        BtnKhoaTK.setRoundTopRight(20);
        BtnKhoaTK.setRoundBottomLeft(20);
        
        BtnThongTinTK.setRoundBottomRight(20);
        BtnThongTinTK.setRoundTopLeft(20);
        BtnThongTinTK.setRoundTopRight(20);
        BtnThongTinTK.setRoundBottomLeft(20);
        
        BtnNhap.setRoundBottomRight(20);
        BtnNhap.setRoundTopLeft(20);
        BtnNhap.setRoundTopRight(20);
        BtnNhap.setRoundBottomLeft(20);
        
        BtnXuat.setRoundBottomRight(20);
        BtnXuat.setRoundTopLeft(20);
        BtnXuat.setRoundTopRight(20);
        BtnXuat.setRoundBottomLeft(20);
        
        BtnThemTaiKhoan.setRoundBottomRight(20);
        BtnThemTaiKhoan.setRoundTopLeft(20);
        BtnThemTaiKhoan.setRoundTopRight(20);
        BtnThemTaiKhoan.setRoundBottomLeft(20);
        ...
        BtnRefresh.setRoundBottomRight(50);
        BtnRefresh.setRoundTopLeft(50);
        BtnRefresh.setRoundTopRight(50);
        BtnRefresh.setRoundBottomLeft(50);
    }                    
    ...
    private Util.PanelRound BtnKhoaTK;
    private Util.PanelRound BtnNhap;
    private Util.PanelRound BtnQLNhanVien;
    private Util.PanelRound BtnQLPhanQuyen;
    private Util.PanelRound BtnRefresh;
    private Util.PanelRound BtnSua;
    private Util.PanelRound BtnThem;
    private Util.PanelRound BtnThemTaiKhoan;
    private Util.PanelRound BtnThongTinTK;
    private Util.PanelRound BtnXuat;
