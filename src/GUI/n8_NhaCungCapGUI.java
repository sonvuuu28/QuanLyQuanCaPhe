                ...
                PanelThongTinLayout.setHorizontalGroup(
                                PanelThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(PanelThongTinLayout.createSequentialGroup()
                                                                .addGap(6, 6, 6)
                                                                .addComponent(PanelNoiDungThongTin,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)));
                        ...
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                                if (TextFieldTimKiem.getText().equals("tìm kiếm tên nhà cung cấp")) {
                                        JOptionPane.showMessageDialog(null,
                                                        "vui lòng nhập tên nhà cung cấp bạn muốn tìm", "thông báo",
                                                        dialog.CANCEL_OPTION);
                                        nccBUS.loadDataToTable_NhaCungCap(Table);
                                        return;
                                } else {
                ...
                btn_Sua.addMouseListener(new java.awt.event.MouseAdapter() {
                        ...
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                                ...
                                if (diachiNCC.length() > 255) {
                                        JOptionPane.showMessageDialog(null,
                                                        "Địa chỉ nhà cung cấp vượt quá độ dài cho phép: " + maxLength
                                                                        + " ký tự.",
                                                        "Lỗi",
                                                        dialog.ERROR_DIALOG);
                                        return;
                                ...
                                if (check.isValidPhoneNumber(sdtNCC) != true) {
                                        JOptionPane.showMessageDialog(null,
                                                        "vui lòng nhập đúng số điện thoại bắt đầu bằng 0 và có 10 số",
                                                        "lỗi", dialog.ERROR_DIALOG);
                                        return;
                                }
                                System.out.println(temp);
                                if (temp == 0) {
                                        JOptionPane.showMessageDialog(null,
                                                        "nhà cung cấp chưa tồn tại, vui lòng chọn thêm nhà cung cấp",
                                                        "lỗi", dialog.ERROR_DIALOG);
                                        return;

                                } else {
                                        if (a.getMaNhaCungCap().equals(maNCC) && a.getTenNhaCungCap().equals(tenNCC)
                                                        && a.getDiaChiNhaCungCap().equals(diachiNCC)
                                                        && a.getSoDienThoaiNhaCungCap().equals(sdtNCC)) {
                                                JOptionPane.showMessageDialog(null,
                                        ...
                                        int choice = JOptionPane.showConfirmDialog(null,
                                                        "Bạn có muốn cập nhật thông tin mới ? ", "Xác Nhận",
                                                        JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);

                                        if (choice == JOptionPane.YES_OPTION) {
                                                if (nccBUS.capNhatNhaCungCap(maNCC, tenNCC, diachiNCC, sdtNCC)) {
                                                        reset();
                                                }
                ...
                btn_Them.addMouseListener(new java.awt.event.MouseAdapter() {
                        ...
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                                ...
                                if (check.IsEmpty(tenNCC) || check.IsEmpty(diachiNCC)
                                                || check.IsEmpty(sdtNCC)) {
                                        JOptionPane.showMessageDialog(null, "bạn chưa nhập thông tin nhà cung cấp mới",
                                                        "lỗi",
                                                        dialog.ERROR_DIALOG);
                                        return;
                                }
                                ...
                                for (int i = 0; i < a.size(); i++) {
                                        if (a.get(i).getMaNhaCungCap().equals(maNCC)) {
                                                JOptionPane.showMessageDialog(null,
                                                                "Mã nhà cung cấp đã tồn tại, hệ thống sẽ cập nhật mã mới",
                                                                "lỗi", dialog.ERROR_DIALOG);
                                                TextFieldMa.setText(maNCCnew);
                                                return;
                                        }
                                ...
                                for (int i = 0; i < a.size(); i++) {
                                        if (a.get(i).getSoDienThoaiNhaCungCap().equals(sdtNCC)) {
                                                JOptionPane.showMessageDialog(null, "số điện thoại đã tồn tại", "lỗi",
                                                                dialog.ERROR_DIALOG);
                                                TextFieldMa.setText(maNCCnew);
                                                return;
                                        }
                                ...
                                int choice = JOptionPane.showConfirmDialog(null, "Bạn có muốn thêm nhà cung cấp mới?",
